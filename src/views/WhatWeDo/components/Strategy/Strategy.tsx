...
import { strategySliderData } from "src/constant";
...
const MultipleSwiperSliderSync = ({
  ...
  const mobileProgressRef06 = useRef<any>(null);
  const mobileProgressRef07 = useRef<any>(null);
  ...
  return (
    <div id="strategy" className="h-screen lg:h-[600px] 2xl:h-[700px]">
      <div
        ...
        onMouseEnter={() => {
          if (width >= 1024) {
            ...
            isDesktop
              ? (mobileProgressRef06.current.style.animationPlayState =
                  "paused")
              : (mobileProgressRef07.current.style.animationPlayState =
                  "paused");
          }
        }}
        onMouseLeave={() => {
      ...
      >
        <div className="h-full w-full absolute lg:right-[21px] top-0 rotate-180">
          <div className="w-full h-full -rotate-180">
            ...
            >
              {strategySliderData.map(
                ({ imageUrl, linkUrl, imageTitle, videoSrc, id }, i) => {
                  return (
                    <SwiperSlide key={"daresddv_" + i}>
                      <Link href={linkUrl}>
                        <a
                          href="#"
        ...
        <DownSliderMobCom
          ...
          array={strategySliderData}
          progressRef={isDesktop ? mobileProgressRef06 : mobileProgressRef07}
        />
