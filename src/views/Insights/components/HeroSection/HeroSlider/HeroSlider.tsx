      ...
      >
        <div className="h-full w-full absolute right-0 top-0 heroControllerSlider rotate-180 !bg-[#000000]">
          <div className="w-full h-full -rotate-180">
            ...
            >
              {insightsHeroSliderData.map(
                ({ imageUrl, linkUrl, imageTitle, videoSrc, id }, i) => {
                  return (
                    <SwiperSlide key={"hnsfhsfs_" + i}>
                      <Link href={linkUrl} passHref>
                        ...
                        >
                          {videoSrc ? (
                            ...
                            <Image
                              src={imageUrl}
                              className="object-cover lg:group-hover:scale-125 duration-[400ms] ease-in-out w-full h-full opacity-[0.8]"
                              layout="fill"
                              alt={imageTitle}
                              priority
                            />
