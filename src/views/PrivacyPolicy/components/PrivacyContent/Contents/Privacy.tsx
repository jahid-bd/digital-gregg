...
import { privacyArticleContentLists } from "src/constant";

const Privacy = () => {
  return (
    <div id="privacy" className="pt-[4rem] ">
      <h4 className="sticky text-[#4B4B4B] font-bold text-[21px] leading-[32px] top-0 py-[1.3rem] bg-[#F7F8F7] pl-[2rem]">
        Privacy Policy
      </h4>
      <div className="pl-[2rem]">
        {privacyArticleContentLists?.map((item, i) => (
          <div className="mb-10" key={"sahsdafa_" + i}>
