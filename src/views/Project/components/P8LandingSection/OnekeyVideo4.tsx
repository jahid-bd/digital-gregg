...
const OnekeyVideo4 = ({ data, isVimeoSrc }: Props) => {
  // States
  ...
  useEffect(() => {
    window.requestAnimationFrame(() => {
      const ProjectVideoTl = gsap.timeline({
        scrollTrigger: {
          trigger: '._oneKeyVideo4Trigger',
          start: '`top 100%',
          scrub: 0.9,
        },
      });
      ProjectVideoTl.to(
        '._oneKeyProjectVideo4',
        {
          y: -150,
          duration: 0.8,
        },
  ...
  return (
    <>
      <div className="bg-[#F5F5F5] lg:p-[5rem_7rem] _oneKeyVideo4Trigger">
        <div className="overflow-hidden hidden lg:block rounded-[0.35714rem] !relative top-32 mt-5 h-full _oneKeyProjectVideo4 shadow-[0_0_26px_0_rgb(0_0_0_/_20%)] w-[50vw] mx-auto">
