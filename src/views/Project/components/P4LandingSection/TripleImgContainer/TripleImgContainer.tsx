    ...
    <div>
      <div className={`lg:block hidden`}>
        <div className={`bg-[#F5F5F5] lg:p-[9.14286rem_4.53782%]`}>
          ...
          >
            <div className="overflow-hidden rounded-[0.35714rem] relative -bottom-20 w-full shadow-[0_0_26px_0_rgb(0_0_0_/_10%)]">
            ...
            {rightImgUrl && (
              <div className="overflow-hidden rounded-[0.35714rem] relative w-full shadow-[0_0_26px_0_rgb(0_0_0_/_10%)] -bottom-20">
                <div className="h-[2.5rem] text-white bg-primary rounded-tl-[0.35714rem] rounded-tr-[0.35714rem] -mb-[2px]">
                  <span className="absolute left-[1rem] text-[35px]">
                    <BsThreeDotsIcon />
                  </span>
