...
const SingleImgContainer: React.FC<Props> = ({ imgUrl, id, imgCss, bgCss }) => {
  useLayoutEffect(() => {
  ...
  return (
    <div>
      <div className={`lg:block hidden lg:relative lg:p-[9.14286rem_4.53782%]`}>
        ...
        ></div>
        <div
          className={`mb-0 ${bgCss} flex justify-around _project9ImageTrigger${id} w-[50vw] mx-auto`}
        >
          <div
            className={`${imgCss} min-h-full translate-y-[2.44267%] flex-grow shrink relative top-16`}
          >
            <div className={`min-h-full _project9Image${id}`}>
