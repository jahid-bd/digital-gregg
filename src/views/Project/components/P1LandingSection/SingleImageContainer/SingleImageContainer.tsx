...
const SingleImageContainer: React.FC<Props> = ({ imgUrl, id, bgCss }) => {
  useLayoutEffect(() => {
  ...
  return (
    <div>
      <div className={`lg:block hidden lg:relative lg:p-[9.14286rem_4.53782%]`}>
        ...
        ></div>
        <div
          className={`mb-0 ${bgCss} flex justify-around _project1ImageTrigger${id}`}
        >
          <div
            className={`h-full max-w-[50vw] flex-grow shrink top-20 relative`}
          >
