...
interface Props {}
const SectionThreeImg: React.FC<Props> = () => {
  useLayoutEffect(() => {
    window.requestAnimationFrame(() => {
      const ProjectImgTl = gsap.timeline({
        scrollTrigger: {
          trigger: `._RapChatSectionThreeTrigger`,
          start: '`top 100%',
          scrub: 0.9,
        },
      });
      ProjectImgTl.to(
        `._RapChatSectionThreeImg`,
        {
          y: -150,
          duration: 0.8,
          ease: 'none',
  ...
  return (
    <div>
      <div className={`lg:block hidden lg:relative lg:p-[9.14286rem_4.53782%]`}>
        ...
        ></div>
        <div
          className={`mb-0 min-h-[34vw] flex justify-around _RapChatSectionThreeTrigger w-[50vw] mx-auto`}
        >
          <div
            className={`min-h-full translate-y-[2.44267%] flex-grow shrink relative`}
          >
            <div className={`min-h-full _RapChatSectionThreeImg`}>
              <div className="shadow-[0_0_26px_0_rgb(0_0_0_/_10%)] rounded-[0.42857rem] relative">
                ...
                <figure className="m-0 relative pt-[2.5rem]">
                  <img
                    src="/images/project/project-6/image-4.webp"
                    alt="image"
      ...
      <div className="lg:hidden block">
        <div className="bg-[#F5F5F5] py-[3.92857rem] md:px-20 px-10 mb-[3.92857rem] rounded-md ">
          <figure className="shadow-[0_0_26px_0_rgb(0_0_0_/_10%)] rounded-b-[0.35714rem] overflow-hidden max-w-[27.14286rem] relative m-auto">
            ...
            <img
              src="/images/project/project-6/image-4-mobile.png"
              alt="image"
              height={'100%'}
              width={'100%'}
            />
...
export default SectionThreeImg;
