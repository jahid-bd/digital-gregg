...
const ImgContainer2: React.FC<Props> = ({ imgUrl, mobImgUrl, id, imgCss }) => {
  useLayoutEffect(() => {
  ...
  return (
    <div>
      <div className={`lg:block hidden lg:relative lg:p-[9.14286rem_4.53782%]`}>
        ...
        >
          <div
            className={`${imgCss} translate-y-[2.44267%] flex-grow shrink relative top-16 max-w-[50vw]`}
          >
            <div className={`min-h-full _project12Image${id}`}>
              <div className=" rounded-[0.42857rem] relative">
