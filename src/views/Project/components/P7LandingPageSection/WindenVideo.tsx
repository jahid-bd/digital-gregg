...
const WindenVideo = ({ data, isVimeoSrc }: Props) => {
  // States
  ...
  useEffect(() => {
    window.requestAnimationFrame(() => {
      const ProjectVideoTl = gsap.timeline({
        scrollTrigger: {
          trigger: '._windenprojectVideoTrigger',
          start: '`top 100%',
          scrub: 0.9,
        },
      });
  ...
  return (
    <>
      <div className="bg-[#F5F5F5] lg:p-[5rem_7rem] _windenprojectVideoTrigger">
        <div className="overflow-hidden hidden lg:block rounded-[0.35714rem] !relative top-32 mt-5 h-full _windenprojectVideo shadow-[0_0_26px_0_rgb(0_0_0_/_20%)] w-[50vw] mx-auto">
