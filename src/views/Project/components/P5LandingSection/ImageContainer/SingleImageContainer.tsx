...
const SingleImageContainer: React.FC<Props> = ({
  imgUrl,
  id,
  imgCss,
  mobileImgUrl,
  ...
  return (
    <div>
      <div className={`lg:block hidden lg:relative lg:p-[9.14286rem_4.53782%]`}>
        <div
          className={`h-[94%] w-full absolute top-0 left-0 bg-[#F5F5F5]`}
        ></div>
        <div
          className={`mb-0 ${bgCss} flex justify-around _project5ImageTrigger${id} w-[50vw] mx-auto`}
        >
          <div className={`${imgCss} min-h-full flex-grow shrink relative`}>
            <div className={`min-h-full _project5Image${id}`}>
